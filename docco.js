...
(function() {
  var Docco, buildMatchers, commander, configure, defaults, document, format, fs, getLanguage, highlightjs, jade, languages, marked, parse, path, run, version, write, _,
    __slice = [].slice;
  ...
  configure = function(options) {
    ...
    config.template = jade.compileFile(config.template, {
      pretty: true
    });
    if (options.marked) {
